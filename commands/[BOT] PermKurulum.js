...
exports.execute = async (client, message, args) => {
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////
    if (args[0] !== "ekle" && args[0] !== "oluştur" && args[0] !== "sil" && args[0] !== "kaldır" && args[0] !== "liste" && args[0] !== "list") return message.lineReply(`ravgar Kendine gel ve komutunu doğru kulan.`);;
    ...
    if (args[0] === "ekle" || args[0] === "oluştur") {
        ...
        if (!verilecekRol) return message.lineReply("ravgar Kendine gel ve komutunu doğru kulan.")
        if (!yetkiliROL) return message.lineReply("ravgar Kendine gel ve komutunu doğru kulan.")
    ...
    if (args[0] === "sil" || args[0] === "kaldır") {
        if (args[1] == "hepsini") {
            ...
            if (!args[1]) return message.lineReply(`ravgar Kendine gel ve komutunu doğru kulan.`);
            ...
            message.reply(`ravgar Kendine gel ve komutunu doğru kulan.`);
            return;
        }
